...
export default function ArtistCard({ artist, onVoteClick }: ArtistCardProps) {
  ...
  return (
    <div className="flex flex-col bg-white/5 border border-white/5 rounded-xl overflow-hidden hover:border-primary/40 transition-all duration-500 group relative">
