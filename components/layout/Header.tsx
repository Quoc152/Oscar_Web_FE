  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${
        isScrolled
          ? "bg-background/90 backdrop-blur-xl border-b border-white/10 py-0"
          : "bg-transparent"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          {isAuthenticated && (
            <div className="hidden md:flex items-center gap-3">
              <div className="flex h-12 items-center gap-2 px-5 bg-secondary/60 border border-primary/30 rounded-full backdrop-blur-sm">
                <div className="flex flex-col items-end justify-center">
                  <span className="text-[8px] text-gray-500 font-bold uppercase tracking-[0.2em] leading-none mb-1">
                    Nhân viên
                  </span>
                  <span className="text-sm font-black text-gradient-tech leading-none tracking-tight">
                    {employeeId}
                  </span>
                </div>
              </div>
              ...
              <div className="flex h-12 items-center gap-4 px-6 bg-secondary/60 border border-primary/30 rounded-full backdrop-blur-sm group hover:border-primary/60 transition-all">
                <div className="flex flex-col items-end justify-center">
              ...
              <button
                ...
                className="cursor-pointer h-12 w-12 flex items-center justify-center bg-secondary/60 border border-red-500/30 rounded-full backdrop-blur-sm hover:border-red-500/60 hover:bg-red-500/10 transition-all group"
                title="Đăng xuất"
              >
        ...
        {mobileMenuOpen && isAuthenticated && (
          <nav className="md:hidden pb-6 animate-in slide-in-from-top duration-300">
            <div className="bg-secondary/90 border border-primary/30 p-6 rounded-2xl space-y-4">
              <div className="flex justify-between items-center">
                <div className="space-y-1">
                  ...
                  <p className="text-gradient-tech text-xs font-bold">
                    Mã: {employeeId}
                  </p>
                </div>
                <div className="bg-primary/10 px-4 py-2 rounded-xl border border-primary/30 flex flex-col items-center">
                  <span className="text-2xl font-black text-gradient-tech">
                    {dailyVoteRemaining}
                  </span>
