...
const categories: Category[] = [
  ...
  },
  {
    ...
    artists: [
      ...
      { id: '12', name: 'Phạm Đình Thái Ngọc', image: '', category: 'Gương mặt mới' },
      { id: '13', name: 'Trương Thảo Nhi', image: '', category: 'Gương mặt mới' },
...
export default function VoteSection() {
  ...
  return (
    <section id="vote" className="relative w-full py-20 bg-black">
      {/* Background effects */}
      <div className="absolute inset-0 z-0">
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl" />
        <div className="absolute top-1/2 right-1/4 w-96 h-96 bg-cyan-400/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Chọn những nghệ sĩ yêu thích nhất của bạn. Bình chọn của bạn rất quan trọng!
          </p>
        </div>
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-gray-400 text-sm">{currentCategory.round}</span>
            <div className="w-12 h-px bg-gradient-to-r from-transparent via-primary to-transparent" />
          </div>
        </div>
