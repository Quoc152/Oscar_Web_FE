      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isLoadingCandidates ? (
          <div className="flex justify-center items-center py-20">
            <div className="text-golden text-lg font-bold animate-pulse">
              Đang tải dữ liệu...
            </div>
          </div>
        ) : (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between bg-dark-blue/40 border border-white/5 rounded-2xl p-2 group">
                <button
                  ...
                  disabled={isVoting}
                  className=" cursor-pointer w-12 h-12 flex items-center justify-center rounded-xl border border-golden/20 text-golden text-xl transition-all hover:bg-golden/10 active:scale-90 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  −
                </button>
